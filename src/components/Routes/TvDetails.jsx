...
import { asyncGetTV } from "../../store/actions/tvActions";
import { cleartv } from "../../store/reducers/tvReducer";
  ...
  return info != null ? (
    ...
    >
      ...
      <div className="w-full">
        ...
        {/*Part 4 -Seasons  &&  Recommendations */}
        {info.details.seasons && <div> <h1 className="mt-4 text-2xl font-semibold text-zinc-300">Seasons</h1>
        <div className="w-full h-[40vh] mt-4">
          <HorizontalCards title={"movie"} data={info.details.seasons}/>
        </div></div>}
        {info.recommendation && info.similar &&<div> <h1 className="mt-4 text-2xl font-semibold text-zinc-300">Recommendations</h1>
        <div className="w-full h-[40vh] mt-4">
